...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Permission::create(['name' => 'dashboard/employees']);
        // Permission::create(['name' => 'dashboard/employees/index']);
        // Permission::create(['name' => 'dashboard/employees/create']);
        // Permission::create(['name' => 'dashboard/employees/store']);
        // Permission::create(['name' => 'dashboard/employees/show']);
        // Permission::create(['name' => 'dashboard/employees/edit']);
        // Permission::create(['name' => 'dashboard/employees/update']);
        // Permission::create(['name' => 'dashboard/employees/destroy']);
